...
export const Finantial: React.FC<PropertyFinancialProps> = ({ data, loading, error }) => {
  if (loading) {
    return (
  ...
  return (
    <section className="px-3 md:pl-5 text-lg">
      ...
      <div className="featureContainer my-[40px] bg-[#F4FAE2] rounded-lg p-4">
        ...
        <ul className="space-y-2  2xl:w-[50%]">
          <li className="flex justify-between">
            ...
            {data.projected_annual_yield}%
          </li>
          <li className="flex justify-between">
            <span>Projected Appreciation</span>
            {data.projected_annual_return}%
          </li>
          <li className="flex justify-between">
            <span>Rental Yield</span>
            {data?.projected_rental_yield !== null && data.projected_rental_yield} %       
          </li>
      ...
      <div className="py-6">
       ...
       {/* just for Opportunistic */}
       {data.investment_category === "Opportunistic" && (
        <>
