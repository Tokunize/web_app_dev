...
import { AdminOverviewColumns } from "@/dataTable/components/columns/overviewAdminColum";
const ActivityLog  = lazy(()=> import("../admin/activityLog"))
import { statuses, investmentCategories } from "@/dataTable/data/data";
...
export const AdminOverview = () => {
    ...
    return (
        <section className="px-[20px] space-y-[40px]">
