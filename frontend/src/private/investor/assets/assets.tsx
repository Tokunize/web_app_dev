...
// Definición del tipo de datos para la tabla
export type RowData = {
  id: string ;
  image: string;
  location: string;
...
export const Assets = () => {
  ...
  const assetsData: RowData[] = properties.map((property) => ({
    id: property.id,
    ...
    priceChart: parseFloat(property.price_change) || 2,
    yield: property.projected_rental_yield || 0,
    capRate: parseFloat(property.cap_rate) || 3.5,
